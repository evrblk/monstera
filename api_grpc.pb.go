...
const (
	MonsteraApi_Update_FullMethodName                = "/pro.spiridonov.monstera.MonsteraApi/Update"
	MonsteraApi_Read_FullMethodName                  = "/pro.spiridonov.monstera.MonsteraApi/Read"
	MonsteraApi_AppendEntriesPipeline_FullMethodName = "/pro.spiridonov.monstera.MonsteraApi/AppendEntriesPipeline"
	MonsteraApi_AppendEntries_FullMethodName         = "/pro.spiridonov.monstera.MonsteraApi/AppendEntries"
	MonsteraApi_RequestVote_FullMethodName           = "/pro.spiridonov.monstera.MonsteraApi/RequestVote"
	MonsteraApi_TimeoutNow_FullMethodName            = "/pro.spiridonov.monstera.MonsteraApi/TimeoutNow"
	MonsteraApi_InstallSnapshot_FullMethodName       = "/pro.spiridonov.monstera.MonsteraApi/InstallSnapshot"
	MonsteraApi_HealthCheck_FullMethodName           = "/pro.spiridonov.monstera.MonsteraApi/HealthCheck"
	MonsteraApi_AddVoter_FullMethodName              = "/pro.spiridonov.monstera.MonsteraApi/AddVoter"
	MonsteraApi_UpdateClusterConfig_FullMethodName   = "/pro.spiridonov.monstera.MonsteraApi/UpdateClusterConfig"
)
...
var MonsteraApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pro.spiridonov.monstera.MonsteraApi",
