...
func GenerateAdapters(monsteraYaml *MonsteraYaml) string {
	...
	f.ImportAlias("github.com/spiridonov/yellowstone/monstera/x", "monsterax")
...
func generateAdapter(f *File, core *MonsteraCore, monsteraYaml *MonsteraYaml) {
	...
	f.Var().Id("_").Qual("github.com/spiridonov/yellowstone/monstera", "ApplicationCore").Op("=").Op("&").Id(adapterName).Values()
	...
	f.Func().Params(
		...
		Qual("github.com/spiridonov/yellowstone/monstera", "ApplicationCoreSnapshot"),
	).Block(
			...
			g.Switch(
				...
				for _, update := range core.Updates {
					g.Case(
						...
						Id("updateResponse").Dot("Error").Op("=").Qual("github.com/spiridonov/yellowstone/monstera/x", "WrapError").Call(
							Id("err"),
						),
					)
				}
			...
			g.Switch(
				...
				for _, read := range core.Reads {
					g.Case(
						...
						Id("readResponse").Dot("Error").Op("=").Qual("github.com/spiridonov/yellowstone/monstera/x", "WrapError").Call(
							Id("err"),
						),
					)
				}
