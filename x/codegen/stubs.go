...
func generateMonsteraStub(f *File, stub *MonsteraStub, cores []*MonsteraCore, monsteraYaml *MonsteraYaml) {
	...
	f.Type().Id(stubName).Struct(
		Id("monsteraClient").Op("*").Qual("github.com/spiridonov/yellowstone/monstera", "MonsteraClient"),
		...
		for _, read := range core.Reads {
			f.Func().Params(
				...
				g.If(
					...
					Return(Id("nil"), Qual("github.com/spiridonov/yellowstone/monstera/x", "NewErrorWithContext").Call(
						Qual("github.com/spiridonov/yellowstone/monstera/x", "Internal"),
